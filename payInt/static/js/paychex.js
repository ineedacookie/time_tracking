		...
		$('#software-interface').on('click', '#save', function(event){ // moves through the set-up process
			...
			$('#software-interface').on('click', '#create-import', function(event) {
				event.preventDefault(); // stop form from submitting
					...
					$.ajax({
						url: 'resources/interface-scripts/paychex_script.php',
						type: 'POST',
						data: data,
						cache: false,
						dataType: 'json',
...
function setupComplete() {
	...
	$('.msg-container-div #notification-msg').html('Ok! You have now completed the preliminary setup. From now on when you log in you will arrive here.');
